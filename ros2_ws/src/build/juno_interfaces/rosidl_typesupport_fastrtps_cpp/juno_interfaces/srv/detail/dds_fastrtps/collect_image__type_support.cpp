...
#include "juno_interfaces/srv/detail/collect_image__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const juno_interfaces::srv::CollectImage_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<juno_interfaces::srv::CollectImage_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CollectImage_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const juno_interfaces::srv::CollectImage_Request *>(
...
static size_t _CollectImage_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CollectImage_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CollectImage_Request__callbacks = {
  "juno_interfaces::srv",
...
static rosidl_message_type_support_t _CollectImage_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CollectImage_Request__callbacks,
...
{
  return &juno_interfaces::srv::typesupport_fastrtps_cpp::_CollectImage_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const juno_interfaces::srv::CollectImage_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<juno_interfaces::srv::CollectImage_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CollectImage_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const juno_interfaces::srv::CollectImage_Response *>(
...
static size_t _CollectImage_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CollectImage_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CollectImage_Response__callbacks = {
  "juno_interfaces::srv",
...
static rosidl_message_type_support_t _CollectImage_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CollectImage_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &juno_interfaces::srv::typesupport_fastrtps_cpp::_CollectImage_Response__handle;
}
...
static service_type_support_callbacks_t _CollectImage__callbacks = {
  "juno_interfaces::srv",
  "CollectImage",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, juno_interfaces, srv, CollectImage_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, juno_interfaces, srv, CollectImage_Response)(),
...
static rosidl_service_type_support_t _CollectImage__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CollectImage__callbacks,
...
{
  return &juno_interfaces::srv::typesupport_fastrtps_cpp::_CollectImage__handle;
}
