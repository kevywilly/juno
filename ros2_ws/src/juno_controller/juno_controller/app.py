...
from juno_controller.image_collector import ImageCollector
from juno_controller.image_utils import (sensor_image_to_cv2, sensor_image_to_jpeg_bytes)
...
class JunoApiNode(Node):
    ...
    def drive(self, direction: str, speed: float):
        msg = apply_drive_cmd(direction, speed)
