...
static const _Toggle_Request_type_support_symbol_names_t _Toggle_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, juno_interfaces, srv, Toggle_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, juno_interfaces, srv, Toggle_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, juno_interfaces, srv, Toggle_Request)() {
  return &::juno_interfaces::srv::rosidl_typesupport_c::Toggle_Request_message_type_support_handle;
}
...
static const _Toggle_Response_type_support_symbol_names_t _Toggle_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, juno_interfaces, srv, Toggle_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, juno_interfaces, srv, Toggle_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, juno_interfaces, srv, Toggle_Response)() {
  return &::juno_interfaces::srv::rosidl_typesupport_c::Toggle_Response_message_type_support_handle;
}
...
static const _Toggle_type_support_symbol_names_t _Toggle_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, juno_interfaces, srv, Toggle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, juno_interfaces, srv, Toggle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, juno_interfaces, srv, Toggle)() {
  return &::juno_interfaces::srv::rosidl_typesupport_c::Toggle_service_type_support_handle;
}
