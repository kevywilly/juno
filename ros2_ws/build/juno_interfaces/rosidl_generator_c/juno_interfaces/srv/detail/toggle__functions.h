...
#ifndef JUNO_INTERFACES__SRV__DETAIL__TOGGLE__FUNCTIONS_H_
#define JUNO_INTERFACES__SRV__DETAIL__TOGGLE__FUNCTIONS_H_
...
/// Create srv/Toggle message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * juno_interfaces__srv__Toggle_Request__init().
...
/// Destroy srv/Toggle message.
/**
 * It calls
 * juno_interfaces__srv__Toggle_Request__fini()
...
/// Check for srv/Toggle message equality.
/**
...
/// Initialize array of srv/Toggle messages.
/**
...
/// Finalize array of srv/Toggle messages.
/**
 * It calls
 * juno_interfaces__srv__Toggle_Request__fini()
...
/// Create array of srv/Toggle messages.
/**
 * It allocates the memory for the array and calls
 * juno_interfaces__srv__Toggle_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Toggle messages.
/**
 * It calls
 * juno_interfaces__srv__Toggle_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Toggle message array equality.
/**
...
/// Copy an array of srv/Toggle messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * juno_interfaces__srv__Toggle_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_juno_interfaces
...
/**
 * It calls
 * juno_interfaces__srv__Toggle_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_juno_interfaces
...
/**
 * It allocates the memory for the array and calls
 * juno_interfaces__srv__Toggle_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_juno_interfaces
...
/**
 * It calls
 * juno_interfaces__srv__Toggle_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // JUNO_INTERFACES__SRV__DETAIL__TOGGLE__FUNCTIONS_H_
