...
#include "juno_interfaces/srv/detail/toggle__rosidl_typesupport_fastrtps_c.h"
...
using _Toggle_Request__ros_msg_type = juno_interfaces__srv__Toggle_Request;
  ...
  void * untyped_ros_message)
{
  ...
  _Toggle_Request__ros_msg_type * ros_message = static_cast<_Toggle_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: on
  {
    uint8_t tmp;
    cdr >> tmp;
...
size_t get_serialized_size_juno_interfaces__srv__Toggle_Request(
  const void * untyped_ros_message,
...
static uint32_t _Toggle_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_juno_interfaces__srv__Toggle_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_juno_interfaces
size_t max_serialized_size_juno_interfaces__srv__Toggle_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Toggle_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_juno_interfaces__srv__Toggle_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, juno_interfaces, srv, Toggle_Request)() {
...
using _Toggle_Response__ros_msg_type = juno_interfaces__srv__Toggle_Response;
  ...
  void * untyped_ros_message)
{
  ...
  _Toggle_Response__ros_msg_type * ros_message = static_cast<_Toggle_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: status
  {
    uint8_t tmp;
    cdr >> tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_juno_interfaces
size_t get_serialized_size_juno_interfaces__srv__Toggle_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Toggle_Response__ros_msg_type * ros_message = static_cast<const _Toggle_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_juno_interfaces__srv__Toggle_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_juno_interfaces
size_t max_serialized_size_juno_interfaces__srv__Toggle_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Toggle_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_juno_interfaces__srv__Toggle_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, juno_interfaces, srv, Toggle_Response)() {
...
// already included above
// #include "juno_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "juno_interfaces/srv/toggle.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, juno_interfaces, srv, Toggle)() {
