...
#include "juno_interfaces/msg/detail/category__rosidl_typesupport_fastrtps_c.h"
...
using _Category__ros_msg_type = juno_interfaces__msg__Category;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Category__ros_msg_type * ros_message = static_cast<const _Category__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Category__ros_msg_type * ros_message = static_cast<_Category__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _Category__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_juno_interfaces__msg__Category(
...
static size_t _Category__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_juno_interfaces__msg__Category(
...
static message_type_support_callbacks_t __callbacks_Category = {
  "juno_interfaces::msg",
  "Category",
...
static rosidl_message_type_support_t _Category__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Category,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, juno_interfaces, msg, Category)() {
  return &_Category__type_support;
}
